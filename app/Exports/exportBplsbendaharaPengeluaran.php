...
class exportBplsbendaharaPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
        if($this->jenisanggaran != 'All'){
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->where('kode_transaksi.bpls', '!=', '')
                    ->whereRaw('kode_transaksi.bpls IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bpls', [
