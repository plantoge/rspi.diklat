...
class exportBplainPenerimaan implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
        $data = DB::table('benpen')
            ...
            ->select(
                ...
                'kode_transaksi_penerimaan.bplain',
            )
            ->where('kode_transaksi_penerimaan.bplain', '!=', '')
            ->whereRaw('kode_transaksi_penerimaan.bplain IS NOT NULL')
        ...
        return view('exportExcel.penerimaan.bplain', [
            'bulan' => $this->bulan,
            'tahun' => $this->tahun,
            'data' => $data,
        ]);
