...
class exportBpudbpPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bpudbp',
                    )
                    ->where('kode_transaksi.bpudbp', '!=', '')
                    ->whereRaw('kode_transaksi.bpudbp IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bpudbp', [
