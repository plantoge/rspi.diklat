...
class exportBpdanabergulirPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bpdana',
                    )
                    ->where('kode_transaksi.bpdana', '!=', '')
                    ->whereRaw('kode_transaksi.bpdana IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bpdana', [
