...
class exportBplainPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bplain',
                    )
                    ->where('kode_transaksi.bplain', '!=', '')
                    ->whereRaw('kode_transaksi.bplain IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bplain', [
