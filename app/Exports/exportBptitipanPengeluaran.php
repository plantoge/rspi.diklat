...
class exportBptitipanPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bpuangtitipan',
                    )
                    ->where('kode_transaksi.bpuangtitipan', '!=', '')
                    ->whereRaw('kode_transaksi.bpuangtitipan IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bpuangtitipan', [
