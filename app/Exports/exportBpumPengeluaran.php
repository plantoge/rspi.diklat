...
class exportBpumPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
        if($this->jenisanggaran != 'All'){
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->where('kode_transaksi.bpum', '!=', '')
                    ->whereRaw('kode_transaksi.bpum IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bpum', [
