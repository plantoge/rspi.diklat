...
class exportBpkasPenerimaan implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
        $data = DB::table('benpen')
            ...
            ->select(
                ...
                'kode_transaksi_penerimaan.bpkas',
            )
            ->where('kode_transaksi_penerimaan.bpkas', '!=', '')
        ...
        return view('exportExcel.penerimaan.bpkas', [
            'bulan' => $this->bulan,
            'tahun' => $this->tahun,
            'data' => $data,
        ]);
