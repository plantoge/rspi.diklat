...
class exportBpuangdibpPenerimaan implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
        $data = DB::table('benpen')
            ...
            ->select(
                ...
                'kode_transaksi_penerimaan.bpuangdibp',
            )
            ->where('kode_transaksi_penerimaan.bpuangdibp', '!=', '')
        ...
        return view('exportExcel.penerimaan.bpuangdibp', [
            'bulan' => $this->bulan,
            'tahun' => $this->tahun,
            'data' => $data,
        ]);
