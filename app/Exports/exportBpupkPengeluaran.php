...
class exportBpupkPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bpupk',
                    )
                    ->where('kode_transaksi.bpupk', '!=', '')
                    ->whereRaw('kode_transaksi.bpupk IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bpupk', [
