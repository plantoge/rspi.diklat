...
class exportBpdepositoPenerimaan implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
        $data = DB::table('benpen')
            ...
            ->select(
                ...
                'kode_transaksi_penerimaan.bpdeposito',
            )
            ->where('kode_transaksi_penerimaan.bpdeposito', '!=', '')
        ...
        return view('exportExcel.penerimaan.bpdeposito', [
            'bulan' => $this->bulan,
            'tahun' => $this->tahun,
            'data' => $data,
        ]);
