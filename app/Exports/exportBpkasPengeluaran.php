...
class exportBpkasPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bpkas',
                    )
                    ->where('kode_transaksi.bpkas', '!=', '')
                    ->whereRaw('kode_transaksi.bpkas IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bpkas', [
