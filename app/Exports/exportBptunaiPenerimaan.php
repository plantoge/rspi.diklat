...
class exportBptunaiPenerimaan implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
        $data = DB::table('benpen')
            ...
            ->select(
                ...
                'kode_transaksi_penerimaan.bptunai',
            )
            ->where('kode_transaksi_penerimaan.bptunai', '!=', '')
        ...
        return view('exportExcel.penerimaan.bptunai', [
            'bulan' => $this->bulan,
            'tahun' => $this->tahun,
            'data' => $data,
        ]);
