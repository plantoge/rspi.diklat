...
class exportBphibahPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bphibah',
                    )
                    ->where('kode_transaksi.bphibah', '!=', '')
                    ->whereRaw('kode_transaksi.bphibah IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bphibah', [
