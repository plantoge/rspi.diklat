...
class exportBpPendapatanPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bppendapatan',
                    )
                    ->where('kode_transaksi.bppendapatan', '!=', '')
                    ->whereRaw('kode_transaksi.bppendapatan IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bppendapatan', [
