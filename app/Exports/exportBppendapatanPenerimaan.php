...
class exportBppendapatanPenerimaan implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
        $data = DB::table('benpen')
            ...
            ->select(
                ...
                'kode_transaksi_penerimaan.bppendapatan',
            )
            ->where('kode_transaksi_penerimaan.bppendapatan', '!=', '')
        ...
        return view('exportExcel.penerimaan.bppendapatan', [
            'bulan' => $this->bulan,
            'tahun' => $this->tahun,
            'data' => $data,
        ]);
