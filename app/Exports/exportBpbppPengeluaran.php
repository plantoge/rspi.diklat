...
class exportBpbppPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bpbpp',
                    )
                    ->where('kode_transaksi.bpbpp', '!=', '')
                    ->whereRaw('kode_transaksi.bpbpp IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bpbpp', [
