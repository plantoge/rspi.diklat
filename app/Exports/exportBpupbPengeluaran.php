...
class exportBpupbPengeluaran implements FromView
{
    protected $bulan;
    protected $tahun;
    ...
    public function view(): View
    {
            ...
            if($this->bulan == 1){
                ...
                $blnsblmnya = DB::table('spby')
                    ...
                    ->select(
                        ...
                        'kode_transaksi.bpupb',
                    )
                    ->where('kode_transaksi.bpupb', '!=', '')
                    ->whereRaw('kode_transaksi.bpupb IS NOT NULL')
        ...
        return view('exportExcel.pengeluaran.bpupb', [
