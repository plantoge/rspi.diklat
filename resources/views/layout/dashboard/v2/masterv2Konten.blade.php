...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="{{url('public/Tdashboard/v2/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
	...
	<!--end::Head-->
	<!--begin::Body-->
	{{-- mode minimize on pasang atribut data dengan isian : data-kt-aside-minimize="on" --}}
	{{-- jika mode minimize off hilangkan atribut data tsb. --}}
	{{-- dan juga pasang class active di class tag dari begin::Aside Toggle --}}
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled" data-kt-aside-minimize="off">
		<!--begin::Main-->
		<!--begin::Root-->
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-extended bg-white" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<!--begin::Primary-->
					@include('layout/dashboard/v2/include/asidePrimary')
					<!--end::Primary-->
					
					<!--begin::Secondary-->
					@include('layout/dashboard/v2/include/asideSecondary')
					<!--end::Secondary-->

					<!--begin::Aside Toggle-->
					{{-- pasang class: active di isian atribut class tag button dibawah   --}}
					<button class="btn btn-sm btn-icon bg-body btn-color-gray-600 btn-active-primary position-absolute translate-middle start-100 end-0 bottom-0 shadow-sm d-none d-lg-flex active" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="aside-minimize" style="margin-bottom: 1.35rem">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					@include('layout/dashboard/v2/include/alert')

					<!--begin::Header-->
					@include('layout/dashboard/v2/include/bHeader')
					<!--end::Header-->


					<!--begin::Content-->
					@include('layout/dashboard/v2/include/cKonten')
					<!--end::Content-->


					<!--begin::Footer-->
					@include('layout/dashboard/v2/include/bFooter')
					<!--end::Footer-->
		...
		<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
			<div class="card shadow-none rounded-0">
				...
				<div class="card-header" id="kt_activities_header">
					<h3 class="card-title fw-bolder text-dark">Activity Logss</h3>
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
												<img src="{{url('public/Tdashboard/v2/media/avatars/150-11.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
												...
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{url('public/Tdashboard/v2/media/avatars/150-3.jpg')}}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{url('public/Tdashboard/v2/media/avatars/150-5.jpg')}}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
									...
									<div class="overflow-auto pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
												<img src="{{url('public/Tdashboard/v2/media/avatars/150-2.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="mb-5 pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
												<img src="{{url('public/Tdashboard/v2/media/avatars/150-6.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="{{url('public/Tdashboard/v2/media/svg/files/pdf.svg')}}" />
												<!--end::Icon-->
												<!--begin::Info-->
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="{{url('public/Tdashboard/v2/media/svg/files/doc.svg')}}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="{{url('public/Tdashboard/v2/media/svg/files/css.svg')}}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
											...
											<div class="overlay me-10">
												...
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-100px" src="{{url('public/Tdashboard/v2/media/stock/300x270/1.jpg')}}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
											...
											<div class="overlay me-10">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-100px" src="{{url('public/Tdashboard/v2/media/stock/300x270/2.jpg')}}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
											...
											<div class="overlay">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-100px" src="{{url('public/Tdashboard/v2/media/stock/300x270/3.jpg')}}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
												<img src="{{url('public/Tdashboard/v2/media/avatars/150-14.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<div class="position-relative">
													...
													<div class="position-absolute translate-middle-y top-50 end-0 me-5">
														<img src="{{url('public/Tdashboard/v2/media/svg/card-logos/visa.svg')}}" alt="" class="h-25px" />
														<img src="{{url('public/Tdashboard/v2/media/svg/card-logos/mastercard.svg')}}" alt="" class="h-25px" />
														<img src="{{url('public/Tdashboard/v2/media/svg/card-logos/american-express.svg')}}" alt="" class="h-25px" />
													</div>
													<!--end::Card logos-->
												</div>
												<!--end::Input wrapper-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100 text-center">
											...
											<div class="text-center px-4 py-15">
												<img src="{{url('public/Tdashboard/v2/media/illustrations/sigma-1/9.png')}}" alt="" class="w-100 mh-300px" />
											</div>
											<!--end::Illustration-->
										</div>
									</div>
		...
		{{-- <script>var hostUrl = {{url('public/Tdashboard/v2/')}};</script> --}}
		<!--begin::Javascript-->
		...
		<script src="{{url('public/Tdashboard/v2/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		{{-- <script src="{{url('public/Tdashboard/v2/js/custom/widgets.js')}}"></script> --}}
