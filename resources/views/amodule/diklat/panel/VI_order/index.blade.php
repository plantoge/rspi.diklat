...
<div class="card card-xxl-stretch">
    <div class="card-header">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder text-dark">Order</span>
            <span class="text-muted mt-1 fw-bold fs-7">Data Order Event</span>
        </h3>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr class="align-middle">
                        ...
                        <td class="text-center">
                            @if ($data->ORDER_STATUS == 'Menunggu Konfirmasi')
                                <p class="text-muted text-left">No action</p>
                            @elseif ($data->ORDER_STATUS == 'Selesai')
                                <a href="{{url('/order-invoice/' . $data->ORDER_ID)}}" class="btn btn-warning btn-sm">Invoice</a>
                            @endif

                            {{-- <a href="{{url('storage/app/bukti_order/' . $data->ORDER_BUKTI)}}" class="btn btn-danger btn-sm" target="_blank">Bukti</a> --}}
