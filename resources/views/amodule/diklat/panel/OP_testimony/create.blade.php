        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-12">
                <div class="mb-5 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" id="testimony_nama" name="nama" class="form-control mb-2" placeholder="" value="{{old('testimony_nama')}}">
            ...
            <div class="col-sm-12 col-lg-12">
                <div class="mb-5 fv-row fv-plugins-icon-container">
                    ...
                    <input type="file" id="testimony_gambar" name="gambar" class="form-control mb-2 ">
            ...
            <div class="col-sm-12 col-lg-12">
                <div class="mb-5 fv-row fv-plugins-icon-container">
                    ...
                    <textarea id="testimony_deskripsi" name="deskripsi" class="tox-target">
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(data.status_code == 422){
                        ...
                        nama        ? $('#namaError').html('<b>'+nama+'</b>')           : $('#namaError').html('<b></b>') 
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = `{{url('panel-testimony')}}`;
                            }
                        });
                    }      
                },
