        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <div class="mb-5 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" id="testimony_nama" name="testimony_nama" class="form-control mb-2" placeholder="" value="{{$testimony->TESTIMONY_NAMA}}">
            ...
            <div class="col-sm-12 col-lg-12">
                <div class="mb-5 fv-row fv-plugins-icon-container">
                    <label class="form-label requi">Upload Foto/Gambar</label>
                    <input type="file" id="testimony_gambar" name="testimony_gambar" class="form-control mb-2 ">
                    {{-- <input type="text" id="testimony_gambarlama" name="testimony_gambarlama" value="{{$testimony->TESTIMONY_GAMBAR}}" class="form-control mb-2" hidden> --}}
                    <a href="{{url('storage/app/gambar_testimony/' . $testimony->TESTIMONY_GAMBAR)}}" target="_blank" class="btn  btn-link btn-sm">{{$testimony->TESTIMONY_GAMBAR}}</a>
